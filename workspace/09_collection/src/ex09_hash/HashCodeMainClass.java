...
/*
 	...
 	입력된 아이디를 검색하고자 합니다.
 	검색의 속도를 높이기 위해서 'hash' 개념이 사용됩니다. 
 	...
 	1) 'april'의 해시코드를 구한다.
 		('april'의 해시코드는 5)
 	2) 해시코드가 5인 'apple', 'bonus', 'bravo' 중에서 'april'을 찾습니다.
 	-> 이렇게 빠른 검색을 위해서 해시코드를 도입하는거다. => 검색할 수 있는 선택지가 6개에서 반으로 줄어듦. 
...
public class HashCodeMainClass {
	...
	public static void main(String[] args) {
		...
		// 중복 확인 유무
		// 1. 해시코드 확인(hashCode())합니다. 해시코드가 같아야 다음 단계로 진행합니다.  (=> 해시코드가 다르면 비교 안함)
