	...
	public static void main(String[] args) {
		...
		try {
			...
			while ( (line = br.readLine()) != null) {
				...
				if (line.contains("link_favorsch @")) {         // line. 했을때 나오는 contain은 charSequence는 String이라고 생각하면 된다.
					// System.out.println(line);
					
					// String[] temps = line.split(">");
					// System.out.println(temps[1]);    // 1번은 두번째 요소다. = 뒤에꺼 (인덱스 특징)
					
					// line.split(">")[1] : 윤세아 출연확정</a
					// line.split(">")[1].split("<") : { "윤세아 출연확정", "/a" }    // -> 그럼 </a에서 < 얘를 가지고 쪼개갰다는말.
